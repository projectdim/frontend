<template>
  <div>
	...
	<div id="Overview" class="px-6">
	  ...
	  <div class="my-2 w-full min-h-[134px] bg-light-blue rounded-lg p-6 flex">
			  <img
...
<!--	#region  Build status-->
		<div class="screen-475:text-overview-item-mobile text-overview-item" >
			<div class="py-4 shadow-2cs">
				<div class="mb-2 flex flex-nowrap">
					<svg :class="getSVGColorClass('buildingCondition', markerReports.buildingCondition)"
					...
					<p class="grow font-semibold my-auto uppercase"
						 :class="getTextColorClass('buildingCondition', markerReports.buildingCondition)">
						{{markerReports.buildingCondition}}
					</p>
					<p class="text-base-grey my-auto font-normal px-1">
						{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
					</p>
				</div>
				<div class="min-h-min bg-gray-light-200 text-base-grey p-2 rounded-sm">
			...
			<div class="flex flex-nowrap py-4 shadow-2cs">
				<svg :class="getSVGColorClass('electricity', markerReports.electricity)"
				...
				<p class="grow font-semibold my-auto uppercase"
					 :class=" getTextColorClass('electricity', markerReports.electricity)">
			...
			<div class="flex flex-nowrap py-4 shadow-2cs">
				<svg :class="getSVGColorClass('carEntrance', markerReports.carEntrance)"
				...
				<p class="grow font-semibold my-auto uppercase"
					 :class="getTextColorClass('carEntrance', markerReports.carEntrance)">
			...
			<div class="flex flex-nowrap py-4 shadow-2cs">
				<svg :class="getSVGColorClass('water', markerReports.water)"
				...
				<p class="grow font-semibold  my-auto uppercase"
					 :class="getTextColorClass('water', markerReports.water)">
					{{markerReports.water}}
				</p>
				<p class="text-base-grey my-auto font-normal px-1">
					{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
			...
			<div class="flex flex-nowrap py-4 shadow-2cs">
				<svg :class="getSVGColorClass('fuelStation',markerReports.fuelStation)"
				...
				<p class="grow font-semibold my-auto uppercase"
					 :class="getTextColorClass('fuelStation',markerReports.fuelStation)">
					{{markerReports.fuelStation}}
					<span v-if="markerReports.fuelStation !== `none`" class="text-base-grey font-semibold">
			...
			<div class="flex flex-nowrap py-4 shadow-2cs">
				<svg :class="getSVGColorClass('hospital',markerReports.hospital)"
				...
				<p class="grow font-semibold my-auto uppercase"
					 :class="getTextColorClass('hospital',markerReports.hospital)">
					{{markerReports.hospital}}
					<span v-if="markerReports.hospital !== `зачинено`" class="text-base-grey font-semibold">
...
<!--	  #endregion-->
	...
	<!--	  region Contact-->
	<div id="contact" class="p-6 bg-gray-light-100 text-overview-item
