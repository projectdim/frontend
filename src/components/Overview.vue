...
<!--	#region  Build status-->
	  <div>
		...
		<div class="flex flex-nowrap text-base py-4 shadow-2cs">
		  <svg :class="markerReports.water === `Стабільна` ? 'fill-safety-green' : 'fill-dangerous-red'"
		...
		<div class="flex flex-nowrap text-base py-4 shadow-2cs">
		  <svg :class="markerReports.hospital === `відчинено` ? 'fill-safety-green' : 'fill-dangerous-red'"
