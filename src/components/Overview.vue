	  ...
	  <div class="my-4">
		...
		<div class="text-base border-b border-base-grey">
			<div class="h-14 flex flex-nowrap">
				<svg :class="markerReports.buildingCondition === `intact` ? 'fill-safety-green' : 'fill-dangerous-red'"
				...
				<p class="grow font-semibold my-auto uppercase"
					:class="markerReports.buildingCondition === `intact` ? 'text-safety-green' : 'text-dangerous-red'">
				  {{markerReports.buildingCondition}}
				</p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="markerReports.electricity === `stable` ? 'fill-safety-green' : 'fill-dangerous-red'"
		  ...
		  <p class="grow font-semibold my-auto uppercase"
			 :class="markerReports.electricity === `stable` ? 'text-safety-green' : 'text-dangerous-red'">
			{{markerReports.electricity}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="markerReports.carEntrance === `accessible` ? 'fill-safety-green' : 'fill-dangerous-red'"
		  ...
		  <p class="grow font-semibold my-auto uppercase"
			 :class="markerReports.carEntrance === `accessible` ? 'text-safety-green' : 'text-dangerous-red'">
			{{markerReports.carEntrance}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="markerReports.water === `stable` ? 'fill-safety-green' : 'fill-dangerous-red'"
		  ...
		  <p class="grow font-semibold my-auto uppercase"
			 :class="markerReports.water === `stable` ? 'text-safety-green' : 'text-dangerous-red'">
			{{markerReports.water}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="markerReports.fuelStation === `open` ? 'fill-safety-green' : 'fill-dangerous-red'"
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="markerReports.hospital === `open` ? 'fill-safety-green' : 'fill-dangerous-red'"
