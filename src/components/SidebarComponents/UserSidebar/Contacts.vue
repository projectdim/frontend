<template>
	<div class="p-6 bg-gray-c-100 text-overview-item
		...
		<div class="screen-475:block flex justify-between py-1 shadow-cs2 mt-2">
			...
			<p class="screen-475:text-left text-right font-semibold text-blue-c-500">
				<a href="tel: +380800501482">
					0 800 501 482
				</a>
			</p>
		</div>
		<div class="screen-475:block flex justify-between py-1">
			<p class="screen-475:mb-1">Державна прикордонна служба України</p>
			<p class="screen-475:text-left text-right font-semibold text-blue-c-500">
