<template>
	<div id="Overview" class="px-6 py-3">
	  ...
	  <div class="my-4">
		...
		<div class="text-base border-b border-base-grey">
			<div class="h-14 flex flex-nowrap">
				...
				<p class="grow font-semibold my-auto"
					:class="selectedDataItem.buildingCondition == `intact` ? 'text-safety-green' : 'text-dangerous-red'">
				  {{this.selectedDataItem.buildingCondition.toUpperCase()}}
				</p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  ...
		  <p class="grow font-semibold my-auto"
			...
			{{this.selectedDataItem.electricity.toUpperCase()}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  ...
		  <p class="grow font-semibold my-auto"
			...
			{{this.selectedDataItem.carEntrance.toUpperCase()}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  ...
		  <p class="grow font-semibold my-auto"
			...
			{{this.selectedDataItem.water.toUpperCase()}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  ...
		  <p class="grow font-semibold my-auto"
			...
			{{this.selectedDataItem.fuelStation.toUpperCase()}}
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  ...
		  <p class="grow font-semibold my-auto"
			...
			{{this.selectedDataItem.hospital.toUpperCase()}}
...
<!--	  #region Form-->
	  <div class="my-4 py-2">
		...
		<div class="my-2 h-min">
		  ...
		  <input type="button" class="block bg-gray-200 text-base-grey border rounded-lg px-8 py-1.5 mt-2"
		  value="Send">
		</div>
	  </div>
<!--	  #endregion-->
