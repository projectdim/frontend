<template>
  <div>
	...
	<div id="Overview" class="px-6">
		<h3 class="font-semibold text-xl py-1.5">Photo ({{this.selectedDataItem.photo.length}})</h3>

	  	<div class="my-1 w-full h-[140px]">
	  ...
	  <h3 class="font-semibold text-xl py-1.5">General Status</h3>

	  <div class="w-full h-[134px] bg-blue-100 rounded-xl p-3 flex flex-nowrap">
			  <img
				  src="https://www.techspring.nl/wp-content/uploads/2021/10/k1g-N8J-thai-nguyen-3xezLdRLdHw-unsplash-scaled.jpg"
				  alt="Test picture"
				  class="h-full max-w-[25%] rounded-xl object-cover"
			  >
			<div class="p-2 align-middle">
				<p>
				  	Here you can find important news updates about your area.
				</p>
...
<!--	#region  Build status-->
	  <div class="my-4">
		...
		<div class="text-base border-b border-base-grey">
			<div class="h-14 flex flex-nowrap">
				<svg :class="selectedDataItem.buildingCondition === `intact` ? 'fill-safety-green' : 'fill-dangerous-red'"
					class="mr-5 my-auto w-1/12" width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<p class="grow font-semibold my-auto uppercase"
					:class="selectedDataItem.buildingCondition === `intact` ? 'text-safety-green' : 'text-dangerous-red'">
				  {{this.selectedDataItem.buildingCondition}}
				</p>
				<p class="text-base-grey text-sm my-auto">
				  {{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
				</p>
			</div>
		  	<div class="min-h-min bg-blue-100 text-base-grey text-xs p-2 mb-2 rounded-sm">
			  	<span v-if="this.selectedDataItem.description.length>0">
			  		{{this.selectedDataItem.description}}
			  	</span>
			  	<span v-else>
				  Description...
				</span>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
<<<<<<< HEAD
		  <svg :class="selectedDataItem.electricity === `stable` ? 'fill-safety-green' : 'fill-dangerous-red'"
=======
		  <svg :class="selectedDataItem.electricity == `Стабільно` ? 'fill-safety-green' : 'fill-dangerous-red'"
>>>>>>> 430dfd10e4ca942a535d27405021ac47ea924ffc
			  width="14" height="22" viewBox="0 0 14 22" fill="none" xmlns="http://www.w3.org/2000/svg"
			   class="mr-5 my-auto w-1/12" >
		  ...
		  <p class="grow font-semibold my-auto uppercase"
<<<<<<< HEAD
			 :class="selectedDataItem.electricity === `stable` ? 'text-safety-green' : 'text-dangerous-red'">
=======
			 :class="selectedDataItem.electricity == `Стабільно` ? 'text-safety-green' : 'text-dangerous-red'">
>>>>>>> 430dfd10e4ca942a535d27405021ac47ea924ffc
			{{this.selectedDataItem.electricity}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="selectedDataItem.carEntrance === `accessible` ? 'fill-safety-green' : 'fill-dangerous-red'"
			   class="mr-5 my-auto w-1/12" width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		  ...
		  <p class="grow font-semibold my-auto uppercase"
			 :class="selectedDataItem.carEntrance === `accessible` ? 'text-safety-green' : 'text-dangerous-red'">
			{{this.selectedDataItem.carEntrance}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
...
<<<<<<< HEAD
		  <svg :class="selectedDataItem.water === `stable` ? 'fill-safety-green' : 'fill-dangerous-red'"
			   class="mr-5 my-auto w-1/12" width="16" height="21" viewBox="0 0 16 21" xmlns="http://www.w3.org/2000/svg">
=======
		  <svg :class="selectedDataItem.water == `Стабільно` ? 'fill-safety-green' : 'fill-dangerous-red'"
			   class="mr-5 my-auto" width="16" height="21" viewBox="0 0 16 21" xmlns="http://www.w3.org/2000/svg">
>>>>>>> 430dfd10e4ca942a535d27405021ac47ea924ffc
		  ...
		  <p class="grow font-semibold my-auto uppercase"
<<<<<<< HEAD
			 :class="selectedDataItem.water === `stable` ? 'text-safety-green' : 'text-dangerous-red'">
=======
			 :class="selectedDataItem.water == `Стабільно` ? 'text-safety-green' : 'text-dangerous-red'">
>>>>>>> 430dfd10e4ca942a535d27405021ac47ea924ffc
			{{this.selectedDataItem.water}}
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		  </p>
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
<<<<<<< HEAD
		  <svg :class="selectedDataItem.fuelStation === `open` ? 'fill-safety-green' : 'fill-dangerous-red'"
			   class="mr-5 my-auto w-1/12" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
=======
		  <svg :class="selectedDataItem.fuelStation == `Відкрито` ? 'fill-safety-green' : 'fill-dangerous-red'"
			   class="mr-5 my-auto" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
>>>>>>> 430dfd10e4ca942a535d27405021ac47ea924ffc
		  ...
		  <p class="grow font-semibold my-auto uppercase"
<<<<<<< HEAD
			 :class="selectedDataItem.fuelStation === `open` ? 'text-safety-green' : 'text-dangerous-red'">
=======
			 :class="selectedDataItem.fuelStation == `Відкрито` ? 'text-safety-green' : 'text-dangerous-red'">
>>>>>>> 430dfd10e4ca942a535d27405021ac47ea924ffc
			{{this.selectedDataItem.fuelStation}}
			<span v-if="this.selectedDataItem.fuelStation != `none`" class="text-base-grey text-sm">
			  ({{this.selectedDataItem.fuelStationDistance}} KM)
			</span>
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
		...
		<div class="flex flex-nowrap h-14 text-base border-b border-base-grey">
		  <svg :class="selectedDataItem.hospital === `open` ? 'fill-safety-green' : 'fill-dangerous-red'"
			   class="mr-5 my-auto w-1/12" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
		  ...
		  <p class="grow font-semibold my-auto uppercase"
			 :class="selectedDataItem.hospital === `open` ? 'text-safety-green' : 'text-dangerous-red'">
			{{this.selectedDataItem.hospital}}
			<span v-if="this.selectedDataItem.hospital != `none`" class="text-base-grey text-sm">
			  ({{this.selectedDataItem.hospitalDistance}} KM)
			</span>
		  </p>
		  <p class="text-base-grey text-sm my-auto">
			{{(new Date(this.selectedDataItem.lastUpdate)).toLocaleString()}}
...
<!--	  #region Form-->
	  <div class="mt-4 py-2">
		<label for="issueMessage" class="text-grey text-sm my-2">
		  It will be helpful if you inform us through this form about any issues by using our service.
		</label>
		<div class="my-2 h-min">
		  <textarea id="issueMessage"
				class="min-h-[50px] resize-none h-max w-full border-base-grey border rounded-lg p-1 "
				placeholder="Leave us a message..." v-model="issueMessage"></textarea>
		  <button @click="this.Show(issueMessage)"
				:disabled="this.isDisabled"
				:class="this.isDisabled ? `bg-gray-200 text-base-grey`:
					`bg-blue-200 text-base-blue hover:border-base-blue`"
				class="block border rounded-lg px-8 py-1.5 mt-2">
			Send
		  </button>
		</div>
	  </div>
<!--	  #endregion-->
	...
	<!--	  region Contact-->
	<div id="contact" class="px-6 py-6 bg-gray-100">
	  <div class="font-semibold py-2">Government Contacts</div>
	  <div class="flex flex-wrap justify-between min-h-8 py-1
			border-b border-grey-200">
		<p>Security Service of Ukraine</p>
		<p class="text-right font-bold text-base-blue">
		  <a href="tel: +380800501482">
		  0 800 501 482
		  </a>
		</p>
	  </div>
	  <div class="flex flex-wrap justify-between min-h-8 py-2">
		<p>State Border Guard Service of Ukraine</p>
		<p class="text-right font-bold text-base-blue">
