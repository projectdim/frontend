<template>
  <div>
	...
	<div id="Overview" class="px-6">
		<h3 class="font-semibold text-sidebar-title">Photo ({{this.selectedDataItem.photo.length || 'none'}})</h3>
	  ...
	  <h3 class="font-semibold text-sidebar-title">General Status</h3>
	  ...
	  <div>
		...
		<div class="flex flex-nowrap text-base py-4 shadow-2cs">
		  ...
		  <p class="grow font-semibold text-overview-item my-auto uppercase"
			...
			<span v-if="markerReports.hospital !== `none`" class="text-base-grey text-overview-item font-semibold">
...
<!--	  #endregion-->
	...
	<div id="contact" class="p-6 bg-gray-light-100">
		<div class="font-semibold text-overview-item">Government Contacts</div>
		<div class="flex flex-wrap justify-between py-1 shadow-2cs mt-2">
			<p class="text-overview-item">Security Service of Ukraine</p>
	  ...
	  <div class="flex flex-wrap justify-between py-1">
		  <p class="text-overview-item">State Border Guard Service of Ukraine</p>
		  <p class="text-right font-bold text-base-blue">
