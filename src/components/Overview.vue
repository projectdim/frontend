...
<!--	#region  Build status-->
      ...
      <div class="min-h-min bg-gray-light-200 text-base-grey p-2 rounded-sm" v-if="markerReports.electricity.description">
			  	<span>
      ...
      <div class="min-h-min bg-gray-light-200 text-base-grey p-2 rounded-sm" v-if="markerReports.carEntrance.description">
			  	<span>
      ...
      <div class="min-h-min bg-gray-light-200 text-base-grey p-2 rounded-sm" v-if="markerReports.water.description">
			  	<span>
      ...
      <div class="min-h-min bg-gray-light-200 text-base-grey p-2 rounded-sm" v-if="markerReports.fuelStation.description">
			  	<span>
      ...
      <div class="min-h-min bg-gray-light-200 text-base-grey p-2 rounded-sm" v-if="markerReports.hospital.description">
			  	<span>
